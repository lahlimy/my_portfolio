        ...
        <div className='xl:container xl:mx-auto'>
            <div className='services-container'>
                <div>
                    ...
                    <Service icon='apps' name='Web Developer' projects='31' />
                    <Service icon='stadia_controller' name='Mobile apps' projects='4' />
                </div>

                <div>
                    <h2 className='services-h1'>Services I offer</h2>
                    <p className='services-p'>Someone who has a passion for their job and cares about helping you succeed and bringing value to your organization, I have been working as a web developer for almost 3 years in various companies.</p>
